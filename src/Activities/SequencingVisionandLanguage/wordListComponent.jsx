...
import { realWords1ShortVowel, realWords2ShortVowel } from "./wordList";
        ...
        <Dropdown.Menu>
          <Dropdown.Item
            ...
            onClick={() => {
              ...
              props.changeArray(realWords1ShortVowel);
            }}
          >
            Real Worlds 1
          </Dropdown.Item>
          <Dropdown.Item
            ...
            onClick={() => {
              ...
              props.changeArray(realWords2ShortVowel);
            }}
          >
            Real Words 2
          </Dropdown.Item>
          <Dropdown.Item
            ...
            onClick={() => {
              ...
              props.changeArray(
                realWords1ShortVowel.concat(realWords2ShortVowel)
              );
            }}
          >
            Everything
