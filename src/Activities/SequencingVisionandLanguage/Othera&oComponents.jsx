...
import { other1, other2, other4, other3, other5 } from "./wordList";
        ...
        <Dropdown.Menu>
          ...
          <Dropdown.Item
            ...
            onClick={() => {
              ...
              props.changeArray(other3);
            }}
          >
            Real Words 3
          </Dropdown.Item>
          <Dropdown.Item
            active={props.wordList === "RW5"}
            onClick={() => {
              props.changeList("RW5");
              props.changeArray(other4);
            }}
          >
            Real Words 4
          </Dropdown.Item>
          <Dropdown.Item
            active={props.wordList === "RW4"}
            onClick={() => {
              props.changeList("RW4");
              props.changeArray(other5);
            }}
          >
            Real Words 5
          </Dropdown.Item>
