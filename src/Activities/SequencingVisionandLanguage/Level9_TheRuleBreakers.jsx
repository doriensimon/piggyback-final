import FlashingPictureButtons from "./wordListRComponent";
import { useState, useRef, useEffect } from "react";
import { breaker1 } from "./wordList";
import useSound from "use-sound";

export default function Level9_TheRuleBreakers(props) {
  var [displayTime, setDisplayTime] = useState("hidden");
  var [time, setTime] = useState(1000);
  var [rawTextArray, setRawTextArray] = useState(breaker1);
